...
/**
 * Used to store all attributes of the Person's Medicalrecord.
 * They're no direct relation between Person and Medicalrecord.
 * Person and Medicalrecord juste share the same attributes firstName and lastName.
 *
